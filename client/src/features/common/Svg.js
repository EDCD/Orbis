 ...
 * Coriolis Logo
 */
export class CoriolisLogo extends Svg {
	/**
	 * Generate the SVG
	 * @return {React.Component} SVG Contents
	 */
 ...
 * Download  / To Inbox
 */
export class Download extends Svg {
	/**
	 * Generate the SVG
	 * @return {React.Component} SVG Contents
	 */
 ...
 * Embed - <>
 */
export class Embed extends Svg {
	/**
	 * Generate the SVG
	 * @return {React.Component} SVG Contents
	 */
 ...
 * Equalizer
 */
export class Equalizer extends Svg {
	/**
	 * Overriden view box
 ...
 * Floppy disk - save
 */
export class FloppyDisk extends Svg {
	/**
	 * Generate the SVG
	 * @return {React.Component} SVG Contents
	 */
 ...
 * Github Logo
 */
export class GitHub extends Svg {
	/**
	 * Overriden view box
	 * @return {String} view box
	 */
 ...
 * Infinite / Infinity
 */
export class Infinite extends Svg {
	/**
	 * Generate the SVG
	 * @return {React.Component} SVG Contents
	 */
 ...
 */
export class LinkIcon extends Svg {
	/**
	 * Generate the SVG
	 * @return {React.Component} SVG Contents
	 */
 ...
 * Link / Permalink / Chain
 */
export class OrbisIcon extends Svg {
	/**
	 * Generate the SVG
	 * @return {React.Component} SVG Contents
	 */
	svg() {
		return (
			<g transform="scale(.037296)">
				<path
					d="m429 319c60.75 0 110 49.248 110 110 0 60.75-49.247 110-110 110s-110-49.247-110-110c0-60.749 49.248-110 110-110m0-20c-34.724 0-67.369 13.522-91.922 38.075s-38.075 57.198-38.075 91.922 13.522 67.369 38.075 91.922c24.553 24.554 57.198 38.075 91.922 38.075s67.369-13.521 91.922-38.075c24.554-24.553 38.075-57.198 38.075-91.922s-13.521-67.369-38.075-91.922c-24.553-24.553-57.198-38.075-91.922-38.075z"/>
				<path
 ...
 * Material
 */
export class MatIcon extends Svg {
	/**
	 * Generate the SVG
	 * @return {React.Component} SVG Contents
	 */
 ...
 */
export class ShoppingIcon extends Svg {
	/**
	 * Overriden view box
	 * @return {String} view box
	 */
 ...
 */
export class NoPower extends Svg {
	/**
	 * Overriden view box
	 * @return {String} view box
	 */
 ...
 */
export class Notification extends Svg {
	/**
	 * Generate the SVG
	 * @return {React.Component} SVG Contents
	 */
 ...
 */
export class Power extends Svg {
	/**
	 * Overriden view box
	 * @return {String} view box
	 */
 ...
 */
export class Question extends Svg {
	/**
	 * Generate the SVG
	 * @return {React.Component} SVG Contents
	 */
 ...
 */
export class Reload extends Svg {
	/**
	 * Generate the SVG
	 * @return {React.Component} SVG Contents
	 */
 ...
 */
export class Warning extends Svg {
	/**
	 * Generate the SVG
	 * @return {React.Component} SVG Contents
	 */
 ...
 * Absolute damage
 */
export class DamageAbsolute extends Svg {
	/**
	 * Overriden view box
	 * @return {String} view box
	 */
 ...
 * Thermal damage
 */
export class DamageThermal extends Svg {
	/**
	 * Overriden view box
	 * @return {String} view box
	 */
 ...
 * Kinetic damage
 */
export class DamageKinetic extends Svg {
	/**
	 * Overriden view box
	 * @return {String} view box
	 */
 ...
 * Explosive damage
 */
export class DamageExplosive extends Svg {
	/**
	 * Overriden view box
	 * @return {String} view box
	 */
 ...
 */
export class MountFixed extends Svg {
	/**
	 * Overriden view box
	 * @return {String} view box
	 */
 ...
 */
export class MountGimballed extends Svg {
	/**
	 * Overriden view box
	 * @return {String} view box
	 */
 ...
 */
export class MountTurret extends Svg {
	/**
	 * Overriden view box
	 * @return {String} view box
	 */
 ...
 * Collapse section
 */
export class CollapseSection extends Svg {
	/**
	 * Overriden view box
	 * @return {String} view box
	 */
 ...
 * Expand section
 */
export class ExpandSection extends Svg {
	/**
	 * Overriden view box
	 * @return {String} view box
	 */
 ...
 * Rocket ship
 */
export class Rocket extends Svg {
	/**
	 * Generate the SVG
	 * @return {React.Component} SVG Contents
	 */
 ...
 */
export class ListModifications extends Svg {
	/**
	 * Overriden view box
	 * @return {String} view box
	 */
 ...
 * Modified (engineers)
 */
export class Modified extends Svg {
	/**
	 * Overriden view box
	 * @return {String} view box
	 */
 ...
 * Hammer
 */
export class Hammer extends Svg {
	/**
	 * Generate the SVG
	 * @return {React.Component} SVG Contents
	 */
 ...
 */
export class StatsBars extends Svg {
	/**
	 * Generate the SVG
	 * @return {React.Component} SVG Contents
	 */
 ...
 * Power Switch - Reset
 */
export class Switch extends Svg {
	/**
	 * Generate the SVG
	 * @return {React.Component} SVG Contents
	 */
 ...
 */
export class StationCoriolis extends Svg {
	/**
	 * Overriden view box
	 * @return {String} view box
	 */
 ...
 */
export class StationOcellus extends Svg {
	/**
	 * Overriden view box
	 * @return {String} view box
	 */
 ...
 */
export class StationOrbis extends Svg {
	/**
	 * Overriden view box
	 * @return {String} view box
	 */
 ...
 */
export class StationOutpost extends Svg {
	/**
	 * Overriden view box
	 * @return {String} view box
	 */
 ...
 * Upload - From inbox
 */
export class Upload extends Svg {
	/**
	 * Generate the SVG
	 * @return {React.Component} SVG Contents
	 */
 ...
 * Login
 */
export class Login extends Svg {
	/**
	 * Generate the SVG
	 * @return {React.Component} SVG Contents
	 */
	svg() {
		return (
			<path
				d="M 26,24 H 20.75 C 20.3375,24 20,23.6625 20,23.25 v -2.5 C 20,20.3375 20.3375,20 20.75,20 H 26 c 1.10625,0 2,-0.89375 2,-2 V 6 C 28,4.89375 27.10625,4 26,4 H 20.75 C 20.3375,4 20,3.6625 20,3.25 V 0.75 C 20,0.3375 20.3375,0 20.75,0 H 26 c 3.3125,0 6,2.6875 6,6 v 12 c 0,3.3125 -2.6875,6 -6,6 z m -2.9375,-12.5625 -10.5,-10.5 C 11.625,0 10,0.65625 10,2 V 8 H 1.5 C 0.66875,8 0,8.66875 0,9.5 v 6 C 0,16.33125 0.66875,17 1.5,17 H 10 v 6 c 0,1.34375 1.625,2 2.5625,1.0625 l 10.5,-10.5 c 0.58125,-0.5875 0.58125,-1.5375 0,-2.125 z"
				id="path2"
				style={{strokeWidth: 0.05}}/>
		);
	}
}
 ...
 * Logout
 */
export class Logout extends Svg {
	/**
	 * Generate the SVG
	 * @return {React.Component} SVG Contents
	 */
	svg() {
		return (
			<path
				d="M 31.2,10.4 H 28 V 7.2 C 28,6.76 27.64,6.4 27.2,6.4 h -1.6 c -0.44,0 -0.8,0.36 -0.8,0.8 v 3.2 h -3.2 c -0.44,0 -0.8,0.36 -0.8,0.8 v 1.6 c 0,0.44 0.36,0.8 0.8,0.8 h 3.2 v 3.2 c 0,0.44 0.36,0.8 0.8,0.8 h 1.6 c 0.44,0 0.8,-0.36 0.8,-0.8 v -3.2 h 3.2 c 0.44,0 0.8,-0.36 0.8,-0.8 v -1.6 c 0,-0.44 -0.36,-0.8 -0.8,-0.8 z m -20,2.4 c 3.535,0 6.4,-2.865 6.4,-6.4 C 17.6,2.865 14.735,0 11.2,0 7.665,0 4.8,2.865 4.8,6.4 c 0,3.535 2.865,6.4 6.4,6.4 z m 4.48,1.6 H 14.845 C 13.735,14.91 12.5,15.2 11.2,15.2 9.9,15.2 8.67,14.91 7.555,14.4 H 6.72 C 3.01,14.4 0,17.41 0,21.12 v 2.08 c 0,1.325 1.075,2.4 2.4,2.4 H 20 c 1.325,0 2.4,-1.075 2.4,-2.4 v -2.08 c 0,-3.71 -3.01,-6.72 -6.72,-6.72 z"
				id="path2"
				style={{strokeWidth: 0.05}}/>
		);
	}
 ...
 * Discord icon
 */
export class Discord extends Svg {
	/**
	 * Overriden view box
	 * @return {String} view box
	 */
	...
	svg() {
		return (
			<path
				d="m 169.83771,138.97142 c 0,8.92343 -6.58285,16.23772 -14.92114,16.23772 -8.192,0 -14.92114,-7.31429 -14.92114,-16.23772 0,-8.92342 6.58286,-16.23771 14.92114,-16.23771 8.33829,0 14.92114,7.31429 14.92114,16.23771 z m -68.31542,-16.23771 c -8.33829,0 -14.92115,7.31429 -14.92115,16.23771 0,8.92343 6.72915,16.23772 14.92115,16.23772 8.33828,0 14.92114,-7.31429 14.92114,-16.23772 0.14628,-8.92342 -6.58286,-16.23771 -14.92114,-16.23771 z M 256,30.13485 v 262.43657 c -36.85371,-32.568 -25.06743,-21.78742 -67.87657,-61.58628 l 7.75314,27.06286 H 29.98857 C 13.45829,258.048 0,244.58971 0,227.91314 V 30.13485 C 0,13.45828 13.45829,0 29.98857,0 H 226.01143 C 242.54171,0 256,13.45828 256,30.13485 Z m -41.69143,138.67886 c 0,-47.104 -21.06514,-85.28457 -21.06514,-85.28457 -21.06514,-15.79886 -41.10629,-15.36 -41.10629,-15.36 l -2.048,2.34057 C 174.95771,78.11657 186.51429,89.088 186.51429,89.088 151.76514,70.04285 110.94629,70.03942 77.23886,84.84571 71.82629,87.33257 68.608,89.088 68.608,89.088 c 0,0 12.14171,-11.55658 38.47314,-19.16343 l -1.46285,-1.75543 c 0,0 -20.04115,-0.43886 -41.10629,15.36 0,0 -21.06514,38.18057 -21.06514,85.28457 0,0 12.288,21.21143 44.61714,22.23543 0,0 5.41257,-6.58286 9.80114,-12.14172 -18.57828,-5.55885 -25.6,-17.26171 -25.6,-17.26171 2.152,1.50629 5.70057,3.45886 5.99772,3.65714 24.69143,13.82743 59.76457,18.35772 91.28228,5.12 5.12,-1.90171 10.82515,-4.68114 16.82286,-8.63085 0,0 -7.31429,11.99542 -26.47771,17.408 4.38857,5.55885 9.65485,11.84914 9.65485,11.84914 32.32915,-1.024 44.76343,-22.23543 44.76343,-22.23543 z"
			/>
		);
	}
}
